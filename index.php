...
Swal.fire({
  ...
  html:"BRYTE-FORCE COMPLETED!!<br>👉<b>Status :</b> Victim password strong, account accessible pending<br><br><b>Note :</b><b>Anonymous Status👉</b> Nobody can track you ⚠️",
  customClass: {
    icon: 'no-border'
  }
});
...
function androidV(ua) { 
   ...
   var match = ua.match(/android\s([0-9\.]*)|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i); 
